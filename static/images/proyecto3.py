"""Segementacion asistida con WaterShed"""
...
# TRACKBARS
from proyectos.proyecto3.trackBar import create_trackbar, on_trackbar, get_trackbar_value
...
while True:
    ...
    if cv.waitKey(1) == ord("c"): # es necesario esperar a la actualización de las trackbars
